    ...
    def generate(self, prompt: str) -> str:
        try:
            response = self.client.chat.completions.create(
                ...
                max_tokens=1000,
                extra_body={
                    "user": '{"appkey": "' + self.cisco_app_key + '"}'
                },
            )
...
def evaluate_answer_relevancy_metric(
    prompt: str, output: str, retrieval_context: list
) -> AnswerRelevancyMetric:
...
def evaluate_all_metrics(
    ...
    ground_truth_db = {
        ...
        "what is the capital of germany?": {
            "context": [
                "Germany is a country in Europe. Berlin is the capital city of Germany."
            ],
            "retrieval_context": [
        ...
        "what is the capital of italy?": {
            "context": [
                "Italy is a country in Europe. Rome is the capital city of Italy."
            ],
            "retrieval_context": [
        ...
        "what is the capital of spain?": {
            "context": [
                "Spain is a country in Europe. Madrid is the capital city of Spain."
            ],
            "retrieval_context": [
        ...
        "what is the capital of united kingdom?": {
            "context": [
                "United Kingdom is a country in Europe. London is the capital city of United Kingdom."
            ],
            "retrieval_context": [
        ...
        "what is the capital of japan?": {
            "context": [
                "Japan is a country in Asia. Tokyo is the capital city of Japan."
            ],
            "retrieval_context": [
        ...
        "what is the capital of australia?": {
            "context": [
                "Australia is a country and continent. Canberra is the capital city of Australia."
            ],
            "retrieval_context": [
        ...
        "what is the capital of brazil?": {
            "context": [
                "Brazil is a country in South America. Brasília is the capital city of Brazil."
            ],
            "retrieval_context": ["Brasília is the capital city of Brazil."],
        },
        "what is the capital of india?": {
            "context": [
                "India is a country in Asia. New Delhi is the capital city of India."
            ],
            "retrieval_context": ["New Delhi is the capital city of India."],
        },
        "what is the capital of united states?": {
            "context": [
                "United States is a country in North America. Washington D.C. is the capital city of United States."
            ],
            "retrieval_context": [
    ...
    if normalized_prompt in ground_truth_db:
        ...
        if not retrieval_context:  # Use lookup if not provided
            retrieval_context = ground_truth_db[normalized_prompt][
                "retrieval_context"
            ]
    else:
    ...
    relevancy_metric = AnswerRelevancyMetric(
        threshold=0.5, model=cisco_llm, async_mode=False
    )
    summarization_metric = SummarizationMetric(
        model=cisco_llm, async_mode=False
    )
    ...
    for metric in metrics:
        try:
            ...
            if hasattr(metric, "score") and metric.score is not None:
                metric_name = (
                    type(metric).__name__.lower().replace("metric", "")
                )
                ...
                metric_label = get_metric_label(
                    metric_name, metric.score, threshold
                )
                ...
                results[metric_name] = {
                    ...
                    "range": "[0,1]",
                    "judge_model": getattr(
                        metric, "evaluation_model", "unknown"
                    ),
                    "threshold": threshold,
                }
